...
class ImageSpam(commands.Cog):
    ...
    async def imagespam_help(self, ctx):
        ...
        embed.add_field(
            name="📝 health check",
            value="• `imagespaminfo health` - checks if all required permissions are set\n",
            inline=False
        )
        embed.add_field(
            name="⚙️ Configuration",
            value="• `imagespam image <1-10>` - Max images (default: 3)\n"
                  "• `imagespam channel <#channel>` - Set log channel\n"
                  "• `imagespam logtoggle <on/off>` - Toggle log notifications",
            inline=False
        )
        embed.add_field(
            name="🔔 Channel Message Settings",
            value="• `imagespam channelmessage <on/off>` - Toggle channel messages\n"
                  "• `imagespam channeltext <text>` - Set channel message text\n"
                  "• `imagespam channelduration <seconds>` - Set message display duration\n"
                  "• `imagespam usermessage <text>` - Set log user message\n"
                  "• `imagespam logmessage <text>` - Set log channel message\n"
                  "• `imagespam timeoutmessage <text>` - Set timeout notification message\n"
                  "• `imagespaminfo placeholders` - Show available placeholders",
            inline=False
        )
        embed.add_field(
            name="⏰ Timeout Settings",
            value="• `imagespam timeouttoggle <on/off>` - Toggle repeated offense timeouts\n"
                  "• `imagespam shorttimeout <seconds>` - Set short feedback timeout (0-60s, 0=off)\n"
                  "• `imagespam timeoutthreshold <number>` - Set violations needed for timeout\n"
                  "• `imagespam timeoutduration <minutes>` - Set timeout duration\n"
                  "• `imagespam timeoutwindow <seconds>` - Set timeout window (default: 300s = 5min)",
            inline=False
        )
        embed.add_field(
            name="📋 Monitoring Settings",
            value="• `imagespam monitorall <on/off>` - Monitor all non-excluded\n"
                  "• `imagespam monitoradmins <on/off>` - Monitor admins\n"
                  "• `imagespam forumthreads <on/off>` - Auto-exclude forum threads\n"
                  "• `imagespam discordlinks <on/off>` - Count Discord CDN image links",
            inline=False
        )
        embed.add_field(
            name="👥 Role Whitelist",
            value="• `imagespam whitelistrole <@role>` - Add role to whitelist (ignored)\n"
                  "• `imagespam removewhitelistrole <@role>` - Remove role from whitelist\n"
                  "• `imagespam listwhitelistroles` - List all whitelisted roles",
            inline=False
        )
        embed.add_field(
            name="🚫 Channel Management",
            value="• `imagespam exclude <#channel>` - Exclude channel from monitoring\n"
                  "• `imagespam include <#channel>` - Remove channel from exclusion list",
            inline=False
        )
        embed.add_field(
            name="📊 Information",
            value="• `imagespaminfo list` - Show settings\n"
                  "• `imagespaminfo channels` - Show all text channels and their status\n"
                  "• `imagespaminfo status` - Check channel status\n"
                  "• `imagespaminfo test <message>` - Test image counting in a message",
            inline=False
        )
        embed.add_field(
            name="👑 Admin Role",
            value="• `imagespam setadminrole <@role>` - Set admin role\n"
                  "• `imagespam clearadminrole` - Clear admin role",
            inline=False
        )
        embed.set_footer(text="Use !imagespaminfo placeholders to see available message placeholders")
    ...
    @imagespam.command(name="whitelistrole")
    ...
    @imagespam.command(name="removewhitelistrole")
    ...
    @imagespam.command(name="listwhitelistroles")
    ...
    @imagespam.command(name="channelmessage")
    ...
    @imagespam.command(name="channeltext")
    ...
    @imagespaminfo.command(name="channels")
    async def list_all_channels(self, ctx):
        ...
        embed.set_footer(text=f"Total text channels: {len(text_channels)} | Use !imagespaminfo status to check a specific channel")
        await ctx.send(embed=embed)

    @imagespaminfo.command(name="status")
    ...
    @imagespam.command(name="channelduration")
    ...
    @imagespam.command(name="timeouttoggle")
    ...
    @imagespam.command(name="timeoutthreshold")
    ...
    @imagespam.command(name="timeoutduration")
    ...
    @imagespam.command(name="shorttimeout")
    ...
    @imagespam.command(name="timeoutwindow")
    ...
    @imagespam.command(name="discordlinks")
    ...
    @imagespaminfo.command(name="test")
    ...
    @imagespam.command(name="usermessage")
    ...
    @imagespam.command(name="logmessage")
    ...
    @imagespam.command(name="timeoutmessage")
    ...
    @imagespaminfo.command(name="placeholders")
    ...
    @imagespam.command(name="channel")
    ...
    @imagespam.command(name="logtoggle")
    ...
    @imagespam.command(name="monitorall")
    ...
    @imagespam.command(name="monitoradmins")
    ...
    @imagespaminfo.command(name="health")
    ...
    @imagespam.command(name="forumthreads")
    ...
    @imagespam.command(name="exclude")
    ...
    @imagespam.command(name="include")
    ...
    @imagespam.command(name="setadminrole")
    async def set_admin_role(self, ctx, role: discord.Role):
        """Set a role that can use imagespam commands."""
        ...
        await ctx.send(f"✅ Admin role set to {role.mention}. Members with this role can now use imagespam commands.")

    @imagespam.command(name="clearadminrole")
    async def clear_admin_role(self, ctx):
        ...
        await ctx.send("✅ Admin role cleared. Only server admins can use imagespam commands.")

    @imagespaminfo.command(name="list")
