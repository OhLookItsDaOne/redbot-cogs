...
This Privacy Policy explains what data the bot ("Tims Bot that can play music", operated for the FUS SkyrimVR community server) collects, stores, and processes, and how it is handled.
