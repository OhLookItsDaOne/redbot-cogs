...
async def on_thread_create(self, thread):
    ...
    try:
        # Attempt to fetch the first message from the thread
        ...
        # Log an error if fetching the first message fails
        print(f"Error fetching the first message in thread {thread.id}: {e}")
